...
var transliteration = require('../lib/translitit-cyrillic-ukrainian-to-latin'),
    buster = require('buster'),
    assert = buster.assertions.assert,
    refute = buster.assertions.refute
;

buster.testCase('A cyrillic ukrainian transliteration', {
    ...
    'should work with Бб': function() {
        assert.equals(transliteration('Борщагівка'), 'Borshchahivka');
    ...
    'should work with Гг': function() {
        assert.equals(transliteration('Гадяч'), 'Hadiach');
        assert.equals(transliteration('Богдан'), 'Bohdan');
    ...
    'should work with Уу': function() {
        assert.equals(transliteration('Ужгород'), 'Uzhhorod');
    ...
    'should work with Щщ': function() {
        ...
        assert.equals(transliteration('Гоща'), 'Hoshcha');
        assert.equals(transliteration('Гаращенко'), 'Harashchenko');
    },
    ...
    'should work with Яя': function() {
        assert.equals(transliteration('Яготин'), 'Yahotyn');
